...
spec.homepage     = "https://github.com/shuftipro/ShuftiProTestPod"
...
spec.source       = { :git => "https://github.com/shuftipro/ShuftiProTestPod.git", :tag => "#{spec.version}" }
